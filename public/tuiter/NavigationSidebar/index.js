const NavigationSidebar = (active) => {
    ...
    <div class="list-group">
        ...
        <a href="../jquery-explore/index.html"
           class="list-group-item list-group-item-action d-flex active ${active === 'explore' ? 'active' : ''}">
        ...
        <a href="../bookmarks/index.html" class="list-group-item list-group-item-action d-flex">
